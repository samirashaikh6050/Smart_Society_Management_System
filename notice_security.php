...
VALUES ('-','$fname','$username','$mobile','$txt')";
        $result1 = mysqli_query($conn,$query2);

        if($result1){
          echo ("<script LANGUAGE='JavaScript'>
          window.alert('Request/Complain Succesfully Sent To Admin, Thank You !!!');
          window.location.href='http://localhost/ns/society/notice_security.php';
          </script>");  
   }
    }else{
?>
...
<button style="margin-left: 40%; margin-top: 15px;" type="submit" value="submit" class="btn btn-danger"> Submit</button></a>
        ...
        <div class="form">
		<form id ="registration" action="notice_security.php" method="post">
